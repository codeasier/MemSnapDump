...
from entities import TraceEntry, DeviceSnapshot
...
if __name__ == '__main__':
    dump_logger.info("Start to dump snapshot slice, reading pickle file.")
    df = pd.read_pickle('test-data/snapshot_1768383987920985470.pkl')
    ...
    slice_dump_hooker = SliceDumpHooker('test-data/slice', 2, max_entries=1000)
